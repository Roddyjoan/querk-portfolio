      ...
      <div className="with-margins">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div class="form-group">
            ...
            <input onChange={handleName} type="text" class="form-control" id="name" aria-describedby="nameHelp" placeholder="John Doe" />
          </div>
          <div class="form-group">
            <label for="address">Address (Street number and name, City, State, Zip Code):</label>
            <input onChange={handleAddress} type="text" class="form-control" id="address" aria-describedby="addressHelp" placeholder="101 Rainbow Rd." />
          </div>
          <div class="form-group">
            <label for="timeestimate">Wait Time (Estimated time for a customer to advance in the queue):</label>
            <input onChange={handleTimeEstimate} type="text" class="form-control" id="timeestimate" aria-describedby="timeestimateHelp" placeholder="John Doe" />
          </div>
          <div class="form-group">
            <label for="username">Email (will also be your username):</label>
            <input onChange={handleUsername} type="email" class="form-control" id="username" aria-describedby="usernameHelp" placeholder="Enter email" />
            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
          </div>
          <div class="form-group">
            <label for="password">Password:</label>
            <input onChange={handlePassword} type="password" class="form-control" id="password" placeholder="Password" />
          </div>
